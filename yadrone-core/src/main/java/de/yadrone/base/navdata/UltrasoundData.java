...
public class UltrasoundData {
    ...
    private final int us_debut_echo;
    private final int us_fin_echo;
    private final int us_association_echo;
    private final int us_distance_echo;
    private final int us_courbe_temps;
    private final int us_courbe_valeur;
    private final int us_courbe_ref;
    private final int flag_echo_ini;
    private final int nb_echo;
    private final long sum_echo;
    private final int alt_temp_raw;
    private final short gradient;

    public UltrasoundData(final int us_debut_echo, final int us_fin_echo, final int us_association_echo,
            final int us_distance_echo, final int us_courbe_temps, final int us_courbe_valeur, final int us_courbe_ref,
            final int flag_echo_ini, final int nb_echo, final long sum_echo, final int alt_temp_raw,
            final short gradient) {
