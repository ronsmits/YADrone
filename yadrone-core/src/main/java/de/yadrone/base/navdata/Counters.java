...
public class Counters {
    private final long double_tap_counter;
    private final long finish_line_counter;

    public Counters(final long double_tap_counter, final long finish_line_counter) {
        super();
