...
public class VisionPerformance {
    private final float time_szo;
    private final float time_corners;
    private final float time_compute;
    private final float time_tracking;
    private final float time_trans;
    private final float time_update;
    private final float[] time_custom;

    public VisionPerformance(final float time_szo, final float time_corners, final float time_compute,
            final float time_tracking, final float time_trans, final float time_update, final float[] time_custom) {
        super();
