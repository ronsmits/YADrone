...
public class VideoStreamData {
    ...
    private final byte quant;
    private final int frame_size;
    private final int frame_number;
    private final int atcmd_ref_seq;
    private final int atcmd_mean_ref_gap;
    private final float atcmd_var_ref_gap;
    private final int atcmd_ref_quality;
    private final int out_bitrate;
    private final int desired_bitrate;
    private final int[] temp_data;
    private final int tcp_queue_level;
    private final int fifo_queue_level;

    public VideoStreamData(final byte quant, final int frame_size, final int frame_number, final int atcmd_ref_seq,
            final int atcmd_mean_ref_gap, final float atcmd_var_ref_gap, final int atcmd_ref_quality,
            final int out_bitrate, final int desired_bitrate, final int[] temp_data, final int tcp_queue_level,
            final int fifo_queue_level) {
        super();
        this.quant = quant;
