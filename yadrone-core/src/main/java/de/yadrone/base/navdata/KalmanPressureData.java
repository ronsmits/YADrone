...
public class KalmanPressureData {
    ...
    private final float offset_pressure;
    private final float est_z;
    private final float est_zdot;
    private final float est_bias_PWM;
    private final float est_biais_pression;
    private final float offset_US;
    private final float prediction_US;
    private final float cov_alt;
    private final float cov_PWM;
    private final float cov_vitesse;
    private final boolean effet_sol;
    private final float somme_inno;
    private final boolean rejet_US;
    private final float u_multisinus;
    private final float gaz_altitude;
    private final boolean multisinus;
    private final boolean multisinus_debut;

    public KalmanPressureData(final float offset_pressure, final float est_z, final float est_zdot,
            final float est_bias_PWM, final float est_biais_pression, final float offset_US, final float prediction_US,
            final float cov_alt, final float cov_PWM, final float cov_vitesse, final boolean effet_sol,
            final float somme_inno, final boolean rejet_US, final float u_multisinus, final float gaz_altitude,
            final boolean multisinus, final boolean multisinus_debut) {
        super();
