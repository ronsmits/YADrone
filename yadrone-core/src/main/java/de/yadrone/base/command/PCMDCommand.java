...
public class PCMDCommand extends ATCommand {
     ...
     */
    public PCMDCommand(final boolean hover, final boolean combined_yaw_enabled, final float left_right_tilt,
            final float front_back_tilt, final float vertical_speed, final float angular_speed) {
        super();
        this.hover = hover;
